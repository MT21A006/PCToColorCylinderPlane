// -*- C++ -*-
/*!
 * @file  PCToColorCylinderPlaneTest.cpp
...
#include "PCToColorCylinderPlaneTest.h"

// Module specification
// <rtc-template block="module_spec">
static const char* pctocolorcylinderplane_spec[] =
  {
    "implementation_id", "PCToColorCylinderPlaneTest",
    "type_name",         "PCToColorCylinderPlaneTest",
 ...
 */
PCToColorCylinderPlaneTest::PCToColorCylinderPlaneTest(RTC::Manager* manager)
 ...
 * @brief destructor
 */
PCToColorCylinderPlaneTest::~PCToColorCylinderPlaneTest()
{
}



RTC::ReturnCode_t PCToColorCylinderPlaneTest::onInitialize()
{
...
/*
RTC::ReturnCode_t PCToColorCylinderPlaneTest::onFinalize()
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorCylinderPlaneTest::onStartup(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorCylinderPlaneTest::onShutdown(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
RTC::ReturnCode_t PCToColorCylinderPlaneTest::onActivated(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}


RTC::ReturnCode_t PCToColorCylinderPlaneTest::onDeactivated(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}


RTC::ReturnCode_t PCToColorCylinderPlaneTest::onExecute(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}

/*
RTC::ReturnCode_t PCToColorCylinderPlaneTest::onAborting(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorCylinderPlaneTest::onError(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorCylinderPlaneTest::onReset(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorCylinderPlaneTest::onStateUpdate(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorCylinderPlaneTest::onRateChanged(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
extern "C"
{
  ...
  void PCToColorCylinderPlaneTestInit(RTC::Manager* manager)
  {
    coil::Properties profile(pctocolorcylinderplane_spec);
    manager->registerFactory(profile,
                             RTC::Create<PCToColorCylinderPlaneTest>,
                             RTC::Delete<PCToColorCylinderPlaneTest>);
  }
