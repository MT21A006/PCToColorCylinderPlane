// -*- C++ -*-
/*!
 * @file  PCToColorCylinderPlaneTest.h
...
#ifndef PCTOCOLORCYLINDERPLANE_TEST__H
#define PCTOCOLORCYLINDERPLANE_TEST_H
...
/*!
 * @class PCToColorCylinderPlaneTest
 * @brief Extract cylinders from point cloud with color
 *
 */
class PCToColorCylinderPlaneTest
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  PCToColorCylinderPlaneTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~PCToColorCylinderPlaneTest();
...
extern "C"
{
  DLL_EXPORT void PCToColorCylinderPlaneTestInit(RTC::Manager* manager);
};

#endif // PCTOCOLORCYLINDERPLANE_TEST_H
