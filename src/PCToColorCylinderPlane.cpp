// -*- C++ -*-
/*!
 * @file  PCToColorCylinderPlane.cpp
...
#include "PCToColorCylinderPlane.h"
...
static const char* pctocolorcylinderplane_spec[] =
  {
    "implementation_id", "PCToColorCylinderPlane",
    "type_name",         "PCToColorCylinderPlane",
 ...
 */
PCToColorCylinderPlane::PCToColorCylinderPlane(RTC::Manager* manager)
 ...
 * @brief destructor
 */
PCToColorCylinderPlane::~PCToColorCylinderPlane()
{
}



RTC::ReturnCode_t PCToColorCylinderPlane::onInitialize()
{
...
/*
RTC::ReturnCode_t PCToColorCylinderPlane::onFinalize()
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorCylinderPlane::onStartup(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorCylinderPlane::onShutdown(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
RTC::ReturnCode_t PCToColorCylinderPlane::onActivated(RTC::UniqueId ec_id)
{
...
RTC::ReturnCode_t PCToColorCylinderPlane::onDeactivated(RTC::UniqueId ec_id)
{
...
RTC::ReturnCode_t PCToColorCylinderPlane::onExecute(RTC::UniqueId ec_id)
{
...
//Plane======================================================================
        ...
        vector<Plane> planes;
        pcl::SACSegmentationFromNormals<PointType, pcl::Normal> sega;
        sega.setOptimizeCoefficients(true);
        sega.setModelType(pcl::SACMODEL_PERPENDICULAR_PLANE);
        sega.setOptimizeCoefficients(true);
        //seg.setAxis(axis);
        sega.setAxis(Eigen::Vector3f(0, 0.8910065242, 0.4539904997));
        sega.setEpsAngle(0.2);//甘いらしい
        //seg.setEpsAngle(deg2rad(15));//15度の許容範囲
        //seg.setModelType(pcl::SACMODEL_PERPENDICULAR_PLANE);
        sega.setNormalDistanceWeight(0.1);
        sega.setMethodType(pcl::SAC_RANSAC);
        sega.setMaxIterations(50);
        sega.setDistanceThreshold(0.03);
        sega.setInputCloud(cloud_filtered);
        sega.setInputNormals(cloud_normals);
        pcl::ModelCoefficients::Ptr coefficients_planes(new pcl::ModelCoefficients);
        pcl::PointIndices::Ptr inliers_planes(new pcl::PointIndices);
        sega.segment(*inliers_planes, *coefficients_planes);
        //cout << "*coefficients_plane: " << *coefficients_plane << endl;

        //平面の抽出
        pcl::ExtractIndices<PointType> extracts;
        extracts.setInputCloud(cloud_filtered);
        extracts.setIndices(inliers_planes);
        extracts.setNegative(false);
        pcl::PointCloud<PointType>::Ptr cloud_planes(new pcl::PointCloud<PointType>());
        extracts.filter(*cloud_planes);
        //cout << "cloud_plane->points.size(): " << cloud_plane->points.size() << endl;
#if 1
//平面の点群の表示
        setPointCloud(m_viewer, cloud_planes, "cloud_planes", true, 255, 255, 0);
#endif
        ...
        ec.setInputCloud(cloud_planes);
        ec.extract(cluster_indices);

        pcl::ExtractIndices<PointType> ext;
        ext.setInputCloud(cloud_planes);
        ...
        *index = cluster_indices[0];
        ...
        m_plane.data.length(7);
        cout << centroid1.x() << endl;
        m_plane.data[0] = centroid1.x();
        m_plane.data[1] = centroid1.y();
        m_plane.data[2] = centroid1.z();
        cout << "①：" << m_plane.data[0] << ",②：" << m_plane.data[1] << ",③：" << m_plane.data[2] << endl;
        found = true;
        //円柱の位置補正
        Eigen::Vector3f center;
        Eigen::Quaternionf rotation;
        float radius;
        revisePlane(rCloud, coefficients_planes, center, rotation, radius);
        m_planeOut.write();
...
/*
RTC::ReturnCode_t PCToColorCylinderPlane::onAborting(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorCylinderPlane::onError(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorCylinderPlane::onReset(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorCylinderPlane::onStateUpdate(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorCylinderPlane::onRateChanged(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
//戻り値： なし
void PCToColorCylinderPlane::selectCylinders(const std::vector<Cylinder>& cylinders, RTC::TimedDoubleSeq& seq)
{
#if 1
    //全ての候補の更新をfalseに
...
//戻り値： なし
void PCToColorCylinderPlane::selectPlanes(const std::vector<Plane>& planes, RTC::TimedDoubleSeq& seq)
{
#if 1
    //全ての候補の更新をfalseに
    ...
    for (i = planes.begin(); i != planes.end(); ++i) {
        ...
        if (dmin != FLT_MAX
            && dmin < m_sameCylinderCenterDistanceLimit
            && abs(i->radius - jmin->plane.radius) < m_sameCylinderRadiusDistanceLimit) {
            //蓄積されたものと平均する
...
extern "C"
{
  ...
  void PCToColorCylinderPlaneInit(RTC::Manager* manager)
  {
    coil::Properties profile(pctocolorcylinderplane_spec);
    manager->registerFactory(profile,
                             RTC::Create<PCToColorCylinderPlane>,
                             RTC::Delete<PCToColorCylinderPlane>);
  }
